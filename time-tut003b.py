...
config = configDictFromFile('time-conf003b.py')
...
g = TFile('fitresultlist123b/fitresultlist123b_%04d.root' % SEED, 'recreate')
...
g.WriteTObject(genEtaList,'fitresultlist123b/fitresultlist123b003_%04d' % SEED)
g.WriteTObject(etaAvg, 'fitresultlist123b/fitresultlist123b003_%04d' % SEED)
g.WriteTObject(etaAvgList, 'fitresultlist123b/fitresultlist123b003_%04d' % SEED)
g.Close()
del g
